...
# 多実行点fill
execute as @e[type=area_effect_cloud,tag=B,limit=1] at @s align xyz if entity @e[type=area_effect_cloud,tag=A,dx=100,dy=100,dz=100] positioned ~64 ~ ~ rotated as @e[tag=x,limit=2] positioned ^ ^ ^32 rotated as @e[tag=x,limit=2] positioned ^ ^ ^16 rotated as @e[tag=x,limit=2] positioned ^ ^ ^8 rotated as @e[tag=x,limit=2] positioned ^ ^ ^4 rotated as @e[tag=x,limit=2] positioned ^ ^ ^2 rotated as @e[tag=x,limit=2] positioned ^ ^ ^1 rotated as @e[tag=x,limit=2] positioned ^ ^ ^0.5 align xyz if entity @e[type=area_effect_cloud,tag=A,dx=100,dy=100,dz=100] positioned ~ ~ ~64 rotated as @e[tag=z,limit=2] positioned ^ ^ ^32 rotated as @e[tag=z,limit=2] positioned ^ ^ ^16 rotated as @e[tag=z,limit=2] positioned ^ ^ ^8 rotated as @e[tag=z,limit=2] positioned ^ ^ ^4 rotated as @e[tag=z,limit=2] positioned ^ ^ ^2 rotated as @e[tag=z,limit=2] positioned ^ ^ ^1 rotated as @e[tag=z,limit=2] positioned ^ ^ ^0.5 align xyz if entity @e[tag=A,dx=100,dy=100,dz=100] positioned ~ ~64 ~ rotated as @e[tag=y,limit=2] positioned ^ ^ ^32 rotated as @e[tag=y,limit=2] positioned ^ ^ ^16 rotated as @e[tag=y,limit=2] positioned ^ ^ ^8 rotated as @e[tag=y,limit=2] positioned ^ ^ ^4 rotated as @e[tag=y,limit=2] positioned ^ ^ ^2 rotated as @e[tag=y,limit=2] positioned ^ ^ ^1 rotated as @e[tag=y,limit=2] positioned ^ ^ ^0.5 align xyz if entity @e[type=area_effect_cloud,tag=A,dx=100,dy=100,dz=100] run setblock ~ ~ ~ stone
