...
# 多実行点fill
execute as @e[tag=B,limit=1] at @s positioned ~63 ~ ~ rotated as @e[tag=x,limit=2] positioned ^ ^ ^32 rotated as @e[tag=x,limit=2] positioned ^ ^ ^16 rotated as @e[tag=x,limit=2] positioned ^ ^ ^8 rotated as @e[tag=x,limit=2] positioned ^ ^ ^4 rotated as @e[tag=x,limit=2] positioned ^ ^ ^2 rotated as @e[tag=x,limit=2] positioned ^ ^ ^1 rotated as @e[tag=x,limit=2] positioned ^ ^ ^0.5 if entity @e[tag=A,dx=100,dy=100,dz=100] positioned ~ ~ ~63 rotated as @e[tag=z,limit=2] positioned ^ ^ ^32 rotated as @e[tag=z,limit=2] positioned ^ ^ ^16 rotated as @e[tag=z,limit=2] positioned ^ ^ ^8 rotated as @e[tag=z,limit=2] positioned ^ ^ ^4 rotated as @e[tag=z,limit=2] positioned ^ ^ ^2 rotated as @e[tag=z,limit=2] positioned ^ ^ ^1 rotated as @e[tag=z,limit=2] positioned ^ ^ ^0.5 if entity @e[tag=A,dx=100,dy=100,dz=100] positioned ~ ~64 ~ rotated as @e[tag=y,limit=2] positioned ^ ^ ^32 rotated as @e[tag=y,limit=2] positioned ^ ^ ^16 rotated as @e[tag=y,limit=2] positioned ^ ^ ^8 rotated as @e[tag=y,limit=2] positioned ^ ^ ^4 rotated as @e[tag=y,limit=2] positioned ^ ^ ^2 rotated as @e[tag=y,limit=2] positioned ^ ^ ^1 rotated as @e[tag=y,limit=2] positioned ^ ^ ^0.5 positioned ~ ~1 ~ if entity @e[tag=A,dx=100,dy=100,dz=100] positioned ~ ~-1 ~ run setblock ~ ~ ~ stone 
